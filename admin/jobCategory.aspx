<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Dashboard.master" AutoEventWireup="true" CodeFile="jobCategory.aspx.cs" Inherits="admin_jobCategory" %>
            ...
            <ContentTemplate>
                <asp:GridView ID="GVUsers" AutoGenerateColumns="false" CssClass="table " runat="server" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="orgId" HeaderText="Org. Name" />
                        <asp:BoundField DataField="catName" HeaderText="Job Category" />
                ...
                <ContentTemplate>
                    <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="from-group">
                                        ...
                                        <asp:DropDownList ID="DDLOrgId" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8 col-sm-12">
                                    <div class="from-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVOrgName" ForeColor="Red" ControlToValidate="TxtOrgName"
                                            ValidationGroup="ValidateJobCat" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="TxtOrgName" runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="from-group">
                                        <label>Cat Name</label>
                                        <asp:RequiredFieldValidator ID="RFVCatName" ForeColor="Red" ControlToValidate="TxtCatName"
                                            ValidationGroup="ValidateJobCat" runat="server" ErrorMessage="*"></asp:RequiredFieldValidator>
                                        <asp:TextBox ID="TxtCatName" runat="server" placeholder="Enter Job Category" CssClass="form-control"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TxtDescr" runat="server" placeholder="Enter Category Description" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                    </div>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="from-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RFVStatus" ForeColor="Red" ControlToValidate="DDLStatus"
                                            ValidationGroup="ValidateJobCat" runat="server" ErrorMessage="*" InitialValue="Select Status..."></asp:RequiredFieldValidator>
                        ...
                        <div class="modal-footer justify-content-between">
                            <asp:Button ID="BtnSave" OnClick="BtnSave_Click" PostBackUrl="~/admin/jobCategory.aspx" runat="server"
                                class="btn btn-primary" ValidationGroup="ValidateJobCat" Text="Save Changes "></asp:Button>
                        </div>
                    </div>
                </ContentTemplate>
                <Triggers>
